...
import { ReviewData } from '../types/order.types';
  ...
  return (
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto p-0">
        <DialogTitle className="sr-only">Đánh giá dịch vụ</DialogTitle>
          ...
          <div className="p-4 md:p-6 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-200">
              ...
              <Button
                ...
                disabled={rating === 0}
                className="w-full bg-gradient-to-r from-yellow-400 to-yellow-500 hover:from-yellow-500 hover:to-yellow-600 text-white disabled:opacity-50"
              >
                Gửi đánh giá
              </Button>
            </div>
