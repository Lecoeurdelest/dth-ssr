...
import {
  getServiceById,
  getServices,
} from "@/modules/services/api/services.mock";
  ...
  useEffect(() => {
    ...
    getServices().then((list) => {
      ...
      const relatedList = list
        .filter((item: any) => item.id !== serviceId)
        .slice(0, 3);
    ...
    <div className="pt-24 pb-16 bg-gradient-to-b from-gray-50 to-white min-h-screen">
      <div className="container mx-auto px-4 max-w-6xl">
          ...
          {details.subServices && details.subServices.length > 0 && (
            <div className="mt-6">
              ...
              <div className="flex flex-wrap gap-2">
                {details.subServices.map((subService: any, index: number) => (
                  <span
                    key={index}
        ...
        <div className="bg-gradient-to-br from-cyan-600 to-blue-600 rounded-3xl p-8 shadow-lg text-white mb-8">
          <h2 className="text-3xl font-bold mb-6">✅ Cam kết của chúng tôi</h2>
          <div className="grid md:grid-cols-2 gap-4">
            {details.commitments.map((commitment: any, index: number) => (
              <div
                key={index}
        ...
        <div className="bg-gradient-to-br from-red-500 to-orange-500 rounded-3xl p-8 shadow-2xl text-white text-center mb-8">
          <h3 className="text-3xl font-bold mb-4">Cần {details.title} ngay?</h3>
