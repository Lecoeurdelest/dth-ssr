...
export const servicesData: Service[] = [
  ...
  {
    id: "sua-dien-tai-nha",
    title: "Sửa điện tại nhà nè",
    description:
      "Sửa chữa hệ thống điện - Thay thế vật liệu hư hỏng - Bảo trì định kỳ càng",
    image:
      "https://images.unsplash.com/photo-1636218685495-8f6545aadb71?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlbGVjdHJpY2lhbiUyMGVsZWN0cmljYWwlMjB3b3JrfGVufDF8fHx8MTc2NTYxNTk2M3ww&ixlib=rb-4.1.0&q=80&w=1080",
    rating: 4.9,
    reviews: 127,
    serviceCount: 8,
    details: {
      title: "SỬA CHỮA ĐIỆN NHÀ",
      description:
        "Dịch vụ sửa chữa điện chuyên nghiệp, an toàn và hiệu quả. Đội ngũ thợ điện có chứng chỉ hành nghề, giàu kinh nghiệm với các hệ thống điện dân dụng và công nghiệp.",
      headerImage:
        "https://images.unsplash.com/photo-1636218685495-8f6545aadb71?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlbGVjdHJpY2lhbiUyMGVsZWN0cmljYWwlMjB3b3JrfGVufDF8fHx8MTc2NTYxNTk2M3ww&ixlib=rb-4.1.0&q=80&w=1080",
      subServices: [
      ...
      pricingCategories: [
        ...
        },
        {
          ...
          items: [
            {
              item: "Lắp đèn, quạt trần, quạt treo",
      ...
      reviews: [
        {
          ...
          date: "2024-12-10",
          comment:
            "Thợ làm việc rất chuyên nghiệp, nhanh gọn. Giá cả hợp lý, không phát sinh thêm chi phí. Rất hài lòng!",
          serviceRating: 5,
          technicianRating: 5,
        },
        {
          ...
          date: "2024-12-08",
          comment:
            "Dịch vụ tốt, thợ tận tâm. Sửa xong chạy ổn định, đã giới thiệu cho bạn bè.",
          serviceRating: 5,
          technicianRating: 5,
        },
        {
          ...
          date: "2024-12-05",
          comment:
            "Làm việc nhanh, tuy nhiên hơi chậm một chút so với hẹn. Nhưng nhìn chung vẫn ok.",
          serviceRating: 4,
          technicianRating: 4,
        },
      ],
  ...
  // 2. Sửa nước tại nhà
  {
    ...
    image:
      "https://images.unsplash.com/photo-1654440122140-f1fc995ddb34?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwbHVtYmVyJTIwd3JlbmNoJTIwd2F0ZXIlMjBwaXBlfGVufDF8fHx8MTc2NTYxNTk2M3ww&ixlib=rb-4.1.0&q=80&w=1080",
    rating: 4.8,
    reviews: 98,
    serviceCount: 9,
    details: {
      title: "SỬA CHỮA NƯỚC",
      description:
        "Dịch vụ sửa chữa hệ thống nước chuyên nghiệp, thông tắc nhanh chóng, hút bể phốt định kỳ. Đội ngũ thợ nước giàu kinh nghiệm, trang bị đầy đủ thiết bị hiện đại.",
      headerImage:
        "https://images.unsplash.com/photo-1654440122140-f1fc995ddb34?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwbHVtYmVyJTIwd3JlbmNoJTIwd2F0ZXIlMjBwaXBlfGVufDF8fHx8MTc2NTYxNTk2M3ww&ixlib=rb-4.1.0&q=80&w=1080",
      subServices: ["Cấp thoát nước", "Thông tắc nước", "Hút bể phốt"],
      pricingCategories: [
        {
          category: "SỬA NƯỚC",
          items: [
        ...
        },
        {
          ...
          items: [
            {
              item: "Hút bể phốt hộ gia đình (xe nhỏ)",
              price: "300.000 – 500.000đ",
            },
            {
              item: "Hút bể phốt nhà hàng – cơ quan",
              price: "500.000 – 900.000đ",
            },
            {
              item: "Nạo vét, kiểm tra bể phốt",
              price: "Liên hệ báo giá cụ thể",
            },
          ],
        },
      ],
      ...
      reviews: [
        {
          ...
          date: "2024-12-11",
          comment:
            "Thông tắc rất nhanh, sạch sẽ. Anh thợ nhiệt tình, giá cả hợp lý.",
          serviceRating: 5,
          technicianRating: 5,
        },
        {
          ...
          date: "2024-12-09",
          comment:
            "Hút bể phốt sạch sẽ, không mùi. Đội thợ làm việc chuyên nghiệp.",
          serviceRating: 5,
          technicianRating: 5,
        },
      ],
  ...
  // 3. Sửa chữa đồ mộc
  {
    ...
    image:
      "https://images.unsplash.com/photo-1704784846246-d81b3542d3d3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3b29kZW4lMjBkb29yJTIwY2FycGVudHJ5fGVufDF8fHx8MTc2NTYxMzg5NHww&ixlib=rb-4.1.0&q=80&w=1080",
    rating: 4.8,
    reviews: 63,
    serviceCount: 10,
    details: {
      title: "SỬA CHỮA ĐỒ MỘC",
      description:
        "Dịch vụ sửa chữa, tân trang đồ gỗ chuyên nghiệp. Thợ mộc giàu kinh nghiệm, tay nghề cao, xử lý mọi vấn đề về đồ gỗ từ nhỏ đến lớn.",
      headerImage:
        "https://images.unsplash.com/photo-1704784846246-d81b3542d3d3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3b29kZW4lMjBkb29yJTIwY2FycGVudHJ5fGVufDF8fHx8MTc2NTYxMzg5NHww&ixlib=rb-4.1.0&q=80&w=1080",
      subServices: ["Sửa chữa đồ mộc", "Thay thế - tân trang"],
      pricingCategories: [
        {
          ...
          items: [
            ...
            {
              item: "Sửa cánh tủ cong vênh, không đóng kín",
              price: "120.000 – 250.000đ",
            },
            {
              item: "Sửa giường gỗ (kêu, gãy nan, long ốc)",
            ...
            {
              item: "Sửa mặt bàn gỗ bong tróc, trầy xước",
              price: "150.000 – 350.000đ",
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              item: "Thay mặt tủ, thay cánh tủ",
              price: "Liên hệ khảo sát báo giá",
            },
            {
              item: "Sơn – phủ lại đồ gỗ",
              price: "Tính theo m², báo giá sau khi xem thực tế",
            },
          ],
        },
      ],
      ...
      reviews: [
        {
          ...
          date: "2024-12-07",
          comment:
            "Sửa giường rất tốt, không còn kêu nữa. Thợ làm việc chuyên nghiệp.",
          serviceRating: 5,
          technicianRating: 5,
        },
        {
  ...
  // 4. Vận chuyển – khuân vác
  {
    ...
    image:
      "https://images.unsplash.com/photo-1758219944627-4d9b32ed7019?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb3ZpbmclMjB0cnVjayUyMGRlbGl2ZXJ5fGVufDF8fHx8MTc2NTYwNDUzNXww&ixlib=rb-4.1.0&q=80&w=1080",
    rating: 4.8,
    reviews: 112,
    serviceCount: 8,
    details: {
      title: "VẬN CHUYỂN – KHUÂN VÁC",
      description:
        "Dịch vụ vận chuyển đồ đạc, chuyển nhà trọn gói chuyên nghiệp. Đội ngũ nhân viên khuân vác khỏe, có kinh nghiệm, cẩn thận với đồ đạc.",
      headerImage:
        "https://images.unsplash.com/photo-1758219944627-4d9b32ed7019?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb3ZpbmclMjB0cnVjayUyMGRlbGl2ZXJ5fGVufDF8fHx8MTc2NTYwNDUzNXww&ixlib=rb-4.1.0&q=80&w=1080",
      subServices: ["Dịch vụ vận chuyển", "Dịch vụ khuân vác"],
      pricingCategories: [
        {
          category: "DỊCH VỤ VẬN CHUYỂN",
          items: [
            {
              item: "Vận chuyển đồ nội thất nhỏ (bàn, ghế, kệ…)",
              price: "100.000 – 200.000đ",
            },
            {
              item: "Vận chuyển máy giặt – tủ lạnh – máy lạnh",
              price: "150.000 – 350.000đ",
            },
            {
              item: "Vận chuyển đồ gia dụng cồng kềnh",
              price: "200.000 – 500.000đ",
            },
            {
              item: "Vận chuyển nhà trọn gói",
              price: "Liên hệ khảo sát báo giá",
            },
            {
              item: "Hỗ trợ vận chuyển ngắn (nội khu)",
              price: "50.000 – 120.000đ",
            },
          ],
        },
        {
          ...
          items: [
            {
              item: "Khuân vác đồ nặng (máy móc, thiết bị…)",
              price: "120.000 – 250.000đ/người",
            },
            { item: "Khuân vác tủ, giường, sofa", price: "150.000 – 300.000đ" },
            {
              item: "Chuyển đồ lên xuống tầng",
              price: "50.000 – 100.000đ/tầng",
            },
            {
              item: "Bốc xếp hàng hóa theo giờ",
              price: "120.000 – 180.000đ/giờ/người",
            },
      ...
      reviews: [
        {
          ...
          date: "2024-12-06",
          comment:
            "Chuyển nhà rất nhanh, không làm hỏng đồ. Đội ngũ rất chuyên nghiệp.",
          serviceRating: 5,
          technicianRating: 5,
        },
        {
  ...
  // 5. Lắp đặt đồ gia dụng
  {
    ...
    image:
      "https://images.unsplash.com/photo-1692731974074-03e7ef257a79?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0diUyMGluc3RhbGxhdGlvbiUyMHJlcGFpcnxlbnwxfHx8fDE3NjU2MTU5NjR8MA&ixlib=rb-4.1.0&q=80&w=1080",
    rating: 4.7,
    reviews: 85,
    serviceCount: 12,
    details: {
      title: "LẮP ĐẶT",
      description:
        "Dịch vụ lắp đặt đồ gia dụng và nội thất chuyên nghiệp. Thợ có tay nghề cao, tư vấn vị trí lắp đặt hợp lý, đảm bảo thẩm mỹ và an toàn.",
      headerImage:
        "https://images.unsplash.com/photo-1692731974074-03e7ef257a79?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0diUyMGluc3RhbGxhdGlvbiUyMHJlcGFpcnxlbnwxfHx8fDE3NjU2MTU5NjR8MA&ixlib=rb-4.1.0&q=80&w=1080",
      subServices: ["Lắp đặt đồ gia dụng", "Lắp đặt đồ nội thất – đồ mộc"],
      pricingCategories: [
        {
          category: "LẮP ĐẶT ĐỒ GIA DỤNG",
          items: [
            {
              item: "Lắp đặt quạt trần/quạt treo",
              price: "100.000 – 200.000đ/món",
            },
            { item: "Lắp máy nước nóng", price: "150.000 – 300.000đ/món" },
      ...
      reviews: [
        {
          ...
          date: "2024-12-12",
          comment:
            "Lắp tủ bếp rất đẹp, chắc chắn. Anh thợ làm cẩn thận, tỉ mỉ.",
          serviceRating: 5,
          technicianRating: 5,
        },
      ],
  ...
  // 6. Đa dịch vụ sửa chữa nhà cửa
  {
    ...
    description:
      "Tổng hợp các dịch vụ sửa chữa nhà cửa - Giải pháp toàn diện cho ngôi nhà",
    image:
      "https://images.unsplash.com/photo-1759434775823-40d8b9577a41?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxob21lJTIwcmVwYWlyJTIwc2VydmljZXMlMjBtYWludGVuYW5jZXxlbnwxfHx8fDE3NjU3MTk2MjR8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    rating: 4.8,
    reviews: 156,
    serviceCount: 15,
    details: {
      title: "ĐA DỊCH VỤ SỬA CHỮA NHÀ CỬA",
      description:
        "Giải pháp toàn diện cho mọi nhu cầu sửa chữa, bảo trì nhà cửa. Đội ngũ thợ đa năng, giàu kinh nghiệm, sẵn sàng hỗ trợ mọi công việc từ nhỏ đến lớn.",
      headerImage:
        "https://images.unsplash.com/photo-1759434775823-40d8b9577a41?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxob21lJTIwcmVwYWlyJTIwc2VydmljZXMlMjBtYWludGVuYW5jZXxlbnwxfHx8fDE3NjU3MTk2MjR8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
      subServices: [
        "Sửa chữa điện – nước",
      ...
      pricingCategories: [
        ...
        },
        {
          ...
          items: [
            {
              item: "Bảo trì định kỳ nhà ở (hàng tháng)",
              price: "500.000 – 1.000.000đ",
            },
            {
              item: "Sửa chữa tổng thể căn hộ",
              price: "Liên hệ khảo sát báo giá",
            },
            {
              item: "Tư vấn và sửa chữa theo yêu cầu",
              price: "Trao đổi trực tiếp",
            },
          ],
        },
        {
      ...
      reviews: [
        {
          ...
          date: "2024-12-13",
          comment:
            "Dịch vụ rất đa dạng, một lần gọi giải quyết được nhiều việc. Rất tiện lợi và chuyên nghiệp!",
          serviceRating: 5,
          technicianRating: 5,
        },
        {
          ...
          date: "2024-12-11",
          comment:
            "Thợ rất đa năng, sửa được nhiều thứ. Giá cả hợp lý, làm việc nhanh gọn.",
          serviceRating: 5,
          technicianRating: 5,
        },
        {
          ...
          date: "2024-12-09",
          comment:
            "Dịch vụ tốt, đội thợ nhiệt tình. Sẽ tiếp tục sử dụng cho các lần sau.",
          serviceRating: 4,
          technicianRating: 5,
        },
      ],
