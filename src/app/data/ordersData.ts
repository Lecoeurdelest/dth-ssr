...
export const ordersData: Order[] = [
  {
    ...
    issueDescription: 'Đèn phòng khách bị hỏng, công tắc không hoạt động. Cần kiểm tra và sửa chữa ngay.',
    issueImages: [
    ...
    timeline: [
      ...
      { status: 'Thợ đang đến', time: '12/12/2024 10:15', completed: true, description: 'Đang di chuyển đến địa chỉ' },
      { status: 'Đang sửa chữa', time: '12/12/2024 10:45', completed: true, description: 'Đã bắt đầu sửa chữa' },
      { status: 'Hoàn thành', time: '12/12/2024 12:00', completed: true, description: 'Đã sửa xong, hoạt động tốt' }
    ],
    costDetails: [
      { item: 'Kiểm tra chẩn đoán sự cố', quantity: 1, unitPrice: 80000, total: 80000 },
      { item: 'Thay công tắc mới', quantity: 2, unitPrice: 100000, total: 200000 },
  ...
  },
  {
    ...
    customerName: 'Nguyễn Văn An',
    customerPhone: '0912345678',
    issueDescription: 'Vòi nước nhà bếp bị rò rỉ, nước chảy yếu. Cần thợ đến kiểm tra và sửa chữa.',
    issueImages: [
    ...
    timeline: [
      ...
      { status: 'Đang sửa chữa', time: '13/12/2024 15:00', completed: true, description: 'Đang thay thế vòi nước' },
      { status: 'Hoàn thành', time: '', completed: false }
    ],
    costDetails: [
      { item: 'Kiểm tra hệ thống nước', quantity: 1, unitPrice: 80000, total: 80000 },
      { item: 'Thay vòi nước mới', quantity: 1, unitPrice: 150000, total: 150000 },
  ...
  },
  {
    ...
    customerName: 'Nguyễn Văn An',
    customerPhone: '0912345678',
    issueDescription: 'Giường ngủ bị kêu, bản lề tủ quần áo bị hỏng. Cần thợ mộc đến sửa chữa.',
    technician: {
      id: 'tech3',
      name: 'Phạm Đức Duy',
    ...
    costDetails: [
      { item: 'Sửa giường gỗ (kêu, long ốc)', quantity: 1, unitPrice: 250000, total: 250000 },
      { item: 'Thay bản lề tủ mới', quantity: 3, unitPrice: 50000, total: 150000 },
  ...
  },
  {
    ...
    customerName: 'Nguyễn Văn An',
    customerPhone: '0912345678',
    issueDescription: 'Chuyển nhà, cần vận chuyển tủ lạnh, máy giặt, bàn ghế và các đồ đạc khác.',
    technician: {
      id: 'tech4',
      name: 'Hoàng Văn Em',
    ...
    costDetails: [
      { item: 'Vận chuyển tủ lạnh', quantity: 1, unitPrice: 200000, total: 200000 },
      { item: 'Vận chuyển máy giặt', quantity: 1, unitPrice: 180000, total: 180000 },
      { item: 'Khuân vác đồ đạc khác', quantity: 1, unitPrice: 270000, total: 270000 }
    ],
    paymentMethod: 'Tiền mặt',
    canReview: true,
    reviewSubmitted: false,
  ...
  },
  {
    ...
    customerName: 'Nguyễn Văn An',
    customerPhone: '0912345678',
    issueDescription: 'Cần lắp đặt tivi treo tường, máy lạnh mới mua. Yêu cầu thợ có kinh nghiệm.',
    timeline: [
      { status: 'Đã đặt dịch vụ', time: '14/12/2024 15:30', completed: true },
      { status: 'Đang xử lý', time: '14/12/2024 15:45', completed: true, description: 'Đang tìm thợ phù hợp' },
      { status: 'Thợ đang đến', time: '', completed: false },
      { status: 'Hoàn thành', time: '', completed: false }
    ],
    costDetails: [
      { item: 'Lắp tivi treo tường', quantity: 1, unitPrice: 200000, total: 200000 },
      { item: 'Lắp máy lạnh (dự kiến)', quantity: 1, unitPrice: 250000, total: 250000 }
    ],
  ...
  },
  {
    ...
    timeline: [
      ...
      { status: 'Đã hủy', time: '09/12/2024 08:00', completed: true, description: 'Khách hàng hủy - Tự xử lý được' }
    ],
    costDetails: [],
  ...
  },
  {
    ...
    costDetails: [
      { item: 'Sửa chữa điện cơ bản', quantity: 1, unitPrice: 150000, total: 150000 },
      { item: 'Sửa chữa nước cơ bản', quantity: 1, unitPrice: 200000, total: 200000 },
      { item: 'Sơn sửa tường phòng ngủ', quantity: 1, unitPrice: 500000, total: 500000 }
    ],
    paymentMethod: 'Chuyển khoản',
    canReview: true,
    reviewSubmitted: false,
    invoice: {
      ...
      status: 'issued',
      warrantyNote: 'Bảo hành sơn tường 1 năm, bảo hành sửa chữa điện nước 6 tháng'
    }
  }
];
