      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-6 left-6 bg-white rounded-xl shadow-xl px-6 py-4 border-2 border-cyan-500">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-bold text-gray-900 text-lg">Đội ngũ chuyên nghiệp</p>
          ...
          <div className="space-y-6">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 leading-tight">
              Đơn vị SỬA CHỮA NHỎ<br />
              Hàng đầu tại Ninh Bình
            </h2>
            <p className="text-gray-600 text-lg leading-relaxed">
              Chúng tôi là đội ngũ thợ chuyên nghiệp với nhiều năm kinh nghiệm trong lĩnh vực 
              sửa chữa điện nước và bảo trì nhà cửa tại tỉnh Ninh Bình. Cam kết mang đến dịch vụ 
              chất lượng cao, giá cả minh bạch và sự hài lòng tuyệt đối cho khách hàng.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed">
              Với phương châm "Chất lượng - Uy tín - Nhanh chóng", chúng tôi luôn đặt lợi ích 
              khách hàng lên hàng đầu, phục vụ tận tâm cho mọi gia đình tại Ninh Bình và các 
              vùng lân cận.
            </p>
            <Button 
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-20">
          <div className="text-center bg-gray-50 rounded-2xl p-6 hover:shadow-lg transition-all">
            <p className="text-4xl md:text-5xl font-bold text-cyan-600 mb-2">10+</p>
            <p className="text-sm md:text-base text-gray-600 leading-tight">Năm kinh nghiệm phục vụ</p>
          </div>
          <div className="text-center bg-gray-50 rounded-2xl p-6 hover:shadow-lg transition-all">
            <p className="text-4xl md:text-5xl font-bold text-cyan-600 mb-2">5000+</p>
            <p className="text-sm md:text-base text-gray-600 leading-tight">Khách hàng tin tưởng</p>
          </div>
          <div className="text-center bg-gray-50 rounded-2xl p-6 hover:shadow-lg transition-all">
            <p className="text-4xl md:text-5xl font-bold text-cyan-600 mb-2">24/7</p>
            <p className="text-sm md:text-base text-gray-600 leading-tight">Hỗ trợ mọi lúc mọi nơi</p>
          </div>
          <div className="text-center bg-gray-50 rounded-2xl p-6 hover:shadow-lg transition-all">
            <p className="text-4xl md:text-5xl font-bold text-cyan-600 mb-2">98%</p>
            <p className="text-sm md:text-base text-gray-600 leading-tight">Khách hàng hài lòng</p>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-2xl p-8 hover:shadow-xl transition-all border border-cyan-100">
            <div className="flex flex-col items-center text-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  Đội ngũ thợ lành nghề, được đào tạo bài bản, có chứng chỉ hành nghề 
