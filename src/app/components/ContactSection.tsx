...
export function ContactSection() {
  ...
  const [chatMessages, setChatMessages] = useState([
    { sender: "bot", text: "Xin chào! Chúng tôi có thể giúp gì cho bạn?" },
  ]);
    ...
    if (chatInput.trim()) {
      ...
      setTimeout(() => {
        setChatMessages([
          ...
          {
            sender: "bot",
            text: "Cảm ơn bạn! Chúng tôi sẽ liên hệ với bạn sớm nhất có thể.",
          },
        ]);
      }, 1000);
    }
      ...
      {isChatOpen && (
        <div className="fixed bottom-4 right-4 w-96 bg-white rounded-lg shadow-2xl border border-gray-200 z-50">
          ...
          <div className="bg-blue-600 text-white p-4 rounded-t-lg flex justify-between items-center">
            <h3 className="font-semibold">Tư vấn miễn phí 24/7</h3>
            <button
